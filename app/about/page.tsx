      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Tabs value={tab} onValueChange={setTab} className="w-full">
          <div className="mb-8 overflow-x-auto">
            <UnderlineTabsList>
              <UnderlineTabsTrigger value="intro">项目介绍</UnderlineTabsTrigger>
              <UnderlineTabsTrigger value="more">更多信息</UnderlineTabsTrigger>
            </UnderlineTabsList>
          </div>
                ...
                <div key={index} className="bg-[--card] rounded-lg p-6">
                  ...
                  <div className="grid gap-6">
                    {section.items.map((item, itemIndex) => (
                      <div
                        key={itemIndex}
                        className="flex flex-col border-b border-[--border] last:border-0 pb-4 last:pb-0"
                      >
