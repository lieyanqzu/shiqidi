                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                <h3 className="font-medium text-[--foreground] flex items-center gap-1">
                                  <a
                                    href={set.code ? `https://sbwsz.com/set/${set.code}?utm_source=shiqidi&order=released_at` : '#'}
                                    target="_blank"
                                ...
                                <div>
                                  <div className="flex items-center gap-2">
                                    <h4 className="font-medium text-[--foreground] flex items-center gap-1">
                                      <a
                                        href={`https://sbwsz.com/set/${set.digital_code}?utm_source=shiqidi&order=released_at`}
                                        target="_blank"
                                        rel="noopener noreferrer"
